...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -D__USE_CMSIS=CMSISv2p00_LPC17xx -DNDEBUG -D__CODE_RED -D__REDLIB__ -I"/mnt/media/Dropbox/Studium/2014 SS/01 Bachelorarbeit/workspace/CMSISv2p00_LPC17xx/inc" -I"/mnt/media/Dropbox/Studium/2014 SS/01 Bachelorarbeit/workspace/RDB1768cmsis2_usbstack/inc" -I../inc -Os -Os -g -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -mcpu=cortex-m3 -mthumb -D__REDLIB__ -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
