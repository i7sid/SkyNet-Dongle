...
p1 = "< paste -d, ".data_in_15min." ".data_in_5min
p2 = "< paste -d, ".data_in_30min." ".data_in_15min
p3 = "< paste -d, ".data_in_30min." ".data_in_5min
p4 = "< paste -d, ".data_in_30min." ".data_in_1min

plot data_in_raw  using 1:2 ls 1 title 'Windgeschwindigkeit', \
    p1 using 1:($4-$2) ls 2 lw 2 title '5min - 15min', \
    p2 using 1:($4-$2) ls 3 lw 2 title '15min - 30min', \
    p3 using 1:($4-$2) ls 4 lw 2 title '5min - 30min', \
    p4 using 1:($4-$2) ls 5 lw 2 title '1min - 30min'
